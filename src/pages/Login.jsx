        ...
        <div className="bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border p-8 shadow-xl">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="w-full mt-4 py-3 rounded-xl border-2 border-gray-300 dark:border-dark-border text-gray-700 dark:text-gray-200 font-semibold hover:border-primary dark:hover:border-primary transition-colors flex items-center justify-center gap-2"
            >
